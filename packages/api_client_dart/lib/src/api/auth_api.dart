...
class AuthApi {
  ...
  Future<Response<OAuthRedirectResponseDtoOutput>> authControllerOauth({
    ...
    OAuthRedirectResponseDtoOutput? _responseData;
    ...
    return Response<OAuthRedirectResponseDtoOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AuthTokenResponseDtoOutput>> authControllerOauthSession({
    ...
    final _path = r'/v1/auth/oauth/session';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<CredentialLoginResponseDtoOutput>>
    ...
    final _path = r'/v1/auth/operator/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<CredentialLoginResponseDtoOutput>>
    ...
    final _path = r'/v1/auth/platform/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
