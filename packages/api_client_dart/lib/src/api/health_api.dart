...
class HealthApi {
  ...
  Future<Response<HealthResponseDtoOutput>> appControllerHealth({
    ...
    HealthResponseDtoOutput? _responseData;
    ...
    return Response<HealthResponseDtoOutput>(
      data: _responseData,
  ...
  Future<Response<MongoHealthResponseDtoOutput>> appControllerMongo({
    ...
    MongoHealthResponseDtoOutput? _responseData;
    ...
    return Response<MongoHealthResponseDtoOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PostgresHealthResponseDtoOutput>> appControllerPostgres({
    ...
    final _path = r'/v1/health/postgres';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PostgresHealthResponseDtoOutput? _responseData;
    ...
    return Response<PostgresHealthResponseDtoOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<QueueHealthResponseDtoOutput>> appControllerQueues({
    ...
    final _path = r'/v1/health/queues';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    QueueHealthResponseDtoOutput? _responseData;
    ...
    return Response<QueueHealthResponseDtoOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RedisHealthResponseDtoOutput>> appControllerRedis({
    ...
    RedisHealthResponseDtoOutput? _responseData;
    ...
    return Response<RedisHealthResponseDtoOutput>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
