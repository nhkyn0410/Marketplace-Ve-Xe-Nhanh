...
| Transport Resource           | `vehicle/`, `route/`, `stop-point/`                                                                                                                                                                           | `VehicleService`, `SeatMapService`, `RouteService`, `RouteStopService`                                                     | Vehicle, SeatMap (layout `JSONB`), Seat, Route, RouteStop, StopPoint Operator-owned; cache distance/duration Mapbox                                                                                                                                                                                                         | đổi xe/sơ đồ ghế sau khi đã có vé                                         |
...
| Cross-cutting                | `common/`, `database/` (Prisma + Mongoose), `redis/`, `external/payment/{vnpay,momo}/`, `external/notification/{email,push,sms}/`, `external/routing/{mapbox,osrm}/`, `external/storage/`, `external/payout/` | `TenantGuard`, rate limiter, audit interceptor, adapter                                                                    | Tenant guard + RLS, rate limiter, audit interceptor, payment/notification/routing/storage/payout adapter                                                                                                                                                                                                                    | sai filter tenant, adapter không verify signature                         |
