...
| Operation                              | `employee_assignments`, `manifests`, `check_in_events`, `journey_logs`, `incident_reports`                       | `employee/`, `manifest/`, `check-in/`, `journey-log/`, `incident/` | Mobile offline/sync cần version/conflict field (employee-mobile, ADR-028)                                                                                                                                                                                           |
